...
class MyApp(App):
    def build(self):
        ...
        self.text_input1.bind(text=self.update_variable)
        self.text_input2.bind(text=self.update_variable)
        self.text_input3.bind(text=self.update_variable)

        return layout

    def update_variable(self, instance, value):
        try:
